...
ui <- 
  navbarPage(
    title = 'Rachel Payne - BF591 Final Project',
    
    #Required - Sample Exploration Section 
    ...
    #Required - Counts Matrix section 
...
server <- function(input, output) {
  ...
  output$counts_scatter<- renderPlot({
    ...
    variance_vs_mean(norm_counts(), TRUE, "Variance vs Mean (DESeq2)",input$slider_zero,input$slider_variance)
  })
